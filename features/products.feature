...
Scenario: Read a product
    ...
    And I press the "Retrieve" button
    Then I should see the message "Success"
    Then I should see "A red fedora" in the "Description"
    Then I should see "True" in the "Available"
    Then I should see "Cloths" in the "Category"
    Then I should see "59.95" in the "Price"
...
Scenario: Update a product
    ...
    And I press the "Retrieve" button
    Then I should see the message "Success"
    Then I should see "Mor" in the "Name"
    When I press the "Clear" button
    And I press the "Search" button
    Then I should see the message "Success"
    And I should see "Mor" in the results
    And I should not see "Hat" in the results

Scenario: Delete a Product
    When I visit the "Home Page"
    And I set the "Name" field to "A red fedora"
    And I press the "Search" button
    Then I should see the message "Success"
    And I should see "Hat" in the "Name" 
    When I copy the "Id" field
